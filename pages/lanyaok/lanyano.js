...
__TENCENT_CHAOS_VM("", false)(13, [], {
    get Page() {
...
}, [ "Page", "txt", "data", "setData", void 0, "onLoad", "onReady", "onShow", "onHide", "onUnload", "onPullDownRefresh", "onReachBottom", "onShareAppMessage", "wx", "navigateTo", "url", "view" ], function h(c, e, d) {
    if (!a(c, Error) || !d || 0 == d.length) return c;
    var f = " [DEBUG pages/lanyaok/lanyano.js:";
    var g = f + d[0] + "]";
    var e = c.stack.split("\n");
