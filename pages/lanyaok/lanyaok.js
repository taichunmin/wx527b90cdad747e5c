...
__TENCENT_CHAOS_VM("", false)(178, [], {
    get Page() {
...
}, [ "Page", "data", void 0, "onLoad", "onReady", "onShow", "onHide", "onUnload", "onPullDownRefresh", "onReachBottom", "onShareAppMessage", "console", "log", "wx", "switchTab", "url", "lintap" ], function h(c, e, d) {
    if (!a(c, Error) || !d || 0 == d.length) return c;
    var f = " [DEBUG pages/lanyaok/lanyaok.js:";
    var g = f + d[0] + "]";
    var e = c.stack.split("\n");
