...
Component({
    ...
    detached: function() {
        for (var e in this._keys) Object.prototype.hasOwnProperty.call(this._keys, e) && (t.default.off("lin-form-blur-" + e), 
    ...
    methods: {
        ...
        _validateForm: function() {
            ...
            return this._forEachNodes(function(r) {
                var o = r.properties.name;
                if (!e.selectComponent("#" + o)) throw new Error("表单项不存在name：" + o);
                r.validatorData(n), t._errors[o] = r.data.errors, i = i.concat(r.data.errors);
            }, !0), i;
        },
        _getValues: function() {
